...
def grammarCheck(text):
    ...
    url = " https://m.search.naver.com/p/csearch/ocontent/spellchecker.nhn?_callback=window.__jindo2_callback._spellingCheck_0&q=%EC%95%88%EB%85%95%EB%94%94%EC%A7%80%EB%AA%AC"
    prams = {"_callback":"window.__jindo2_callback._spellingCheck_0","q":text}
...
def make_reply(text):
    ...
    for word in words:
        face = word[0]
        if face in dic: make_sentence(face)
